As a river contains lots of pixels, and the process of flow is basically an process of sequential pixel traversal, thus it's rather important to determine the traverse order of pixels.
